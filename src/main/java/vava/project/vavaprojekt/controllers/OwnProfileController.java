...
public final class OwnProfileController  extends Controller {
    ...
    @FXML private TextFlow textFlow_description;
    ...
    protected void initialize() {
        ...
        //textFlow_description.setText(); TODO textFlow nema .setText()...
    ...
    private void saveChanges(MouseEvent mouseEvent) {
        ...
        //String new_desc = textFlow_description.getText(); TODO textFlow nema .getText()...
        ...
        app.getUser().updatePassword(act_pass, new_pass, new_pass_check);
